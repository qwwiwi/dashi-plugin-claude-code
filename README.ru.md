...
15. [Что нового в v1.1.0 — rich messages, Guest Mode, context HUD + статус-пин](#15-что-нового-в-v110--rich-messages-guest-mode-context-hud--статус-пин)
...
## 15. Что нового в v1.1.0 — rich messages, Guest Mode, context HUD + статус-пин

Всё, что вышло в начале июля 2026 (PR #86, #94–#97). Полная история: [CHANGELOG.md](CHANGELOG.md); как выпускаются релизы: [docs/RELEASING.md](docs/RELEASING.md).
